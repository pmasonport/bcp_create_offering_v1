export const OFFERINGS = [
  ...
  { id:"team", group:"dsop", name:"Docker Team", slug:"docker-team", desc:"Collaboration tier for small teams (1 seat minimum)", pkg:"bundle", mon:"subscription", acct:"organization", channel:["self-serve", "sales-led"], price:"$16/seat", cycle:"monthly", altPrice:"$180/seat", altCycle:"annual", status:"active" },
  { id:"business", group:"dsop", name:"Docker Business", slug:"docker-business", desc:"Enterprise tier with security and admin features (1 seat minimum)", pkg:"bundle", mon:"subscription", acct:"organization", channel:["self-serve", "sales-led"], price:"$24/seat", cycle:"annual only", status:"active" },
  // Build Cloud
  ...
  { id:"dhi-sel", group:"dhi", name:"Select", slug:"dhi-select-org", desc:"Production-ready security with compliance support", pkg:"standalone", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$5,000/repo", cycle:"annual", status:"active" },
  { id:"dhi-ent-r", group:"dhi", name:"Enterprise (Per-Repo)", slug:"dhi-enterprise-per-repo", desc:"CVE SLAs, FIPS/STIG, compliance, mirroring", pkg:"standalone", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$8,000/repo", cycle:"annual", status:"active" },
  { id:"dhi-ent-f", group:"dhi", name:"Enterprise (Full Catalog)", slug:"dhi-enterprise-full-catalog", desc:"Full catalog access, unlimited repos", pkg:"standalone", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$200,000", cycle:"annual · fixed", status:"active" },
  { id:"dhi-els-r", group:"dhi", name:"ELS (Per-Repo)", slug:"dhi-els-per-repo", desc:"+5 yrs hardened updates for EOL software", pkg:"add_on", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$8,000/repo", cycle:"annual", status:"active", requires:"Enterprise (Per-Repo)" },
  { id:"dhi-els-f", group:"dhi", name:"ELS (Full Catalog)", slug:"dhi-els-full-catalog", desc:"+5 yrs hardened updates for EOL software", pkg:"add_on", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$200,000", cycle:"annual · fixed", status:"active", requires:"Enterprise (Full Catalog)" },
  // Premium Support
  { id:"prem", group:"premium-support", name:"Premium Support", slug:"premium-support-org", desc:"24×7 support with priority SLAs, escalation, live troubleshooting, and RCA", pkg:"add_on", mon:"subscription", acct:"organization", channel:["sales-led"], price:"$40,000", cycle:"annual · fixed", status:"active", requires:"Docker Business or Enterprise (Per-Repo) or (Full Catalog)" },
  // Gordon
